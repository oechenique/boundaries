...
In the accompanying notebook, you can find the Python implementation of the process. Check out the [shapefile notebook]([https://github.com/tu-usuario/tu-repositorio/blob/main/tu-carpeta/tu-notebook.ipynb](https://github.com/oechenique/boundaries/blob/main/Notebook/shapefile.ipynb)){:target="_blank"} for a detailed example.
